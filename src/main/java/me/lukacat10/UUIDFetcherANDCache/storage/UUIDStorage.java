package me.lukacat10.UUIDFetcherANDCache.storage;
...
public class UUIDStorage {
	...
	private final MainJavaPlugin plugin;
...
//			plugin.debugMessage("Loading uuids_" + suffix + " ..."); TODO: DEBUG?!
...
//						+ "' with uuid " + uuid + "!"); TODO: DEBUG?!
				return;
			}

			config.set(oldUser, null);

//			plugin.debugMessage("Deleting old user '" + oldUser + "'!"); TODO: DEBUG?!
		}
